...
FROM registry1.dso.mil/ironbank/opensource/nodejs/nodejs16:16.18.1  AS builder
USER node
WORKDIR /home/node
...
# Nextjs server
FROM registry1.dso.mil/ironbank/opensource/nodejs/nodejs16:16.18.1 AS application
USER node
WORKDIR /app
